...
//format number ref. http://okadao.blogspot.jp/2009/10/javascript3.html
...
*/
        ...
        $tableDetail.append($("<tr style=\"color:#333; background:#ded;\"/>")
            .append($('<td width="8%"></td>').text("日付"))
            .append($('<td width="15%"></td>').text("借方　科目"))
            .append($('<td width="15%"></td>').text("補助科目"))
            .append($('<td width="15%"></td>').text("貸方　科目"))
            .append($('<td width="15%"></td>').text("補助科目"))
            .append($('<td align="center" width="8%"></td>').text("借方"))
            .append($('<td align="center" width="8%"></td>').text("貸方"))
            .append($('<td></td>').text("コメント")));
        ...
        $entryDetails.each(function(line, detail) {
            ...
            // Detail table
            console.log($postingDate.text() + ' ' + $debitCreditCode.text() + ' ' + $accountMainDescription.text() + ' ' + $amount.text() + ' ' + $detailComment.text());
            if ($debitCreditCode.text()=='debit') {
                console.log('debit');
                $tableDetail.append($("<tr/>")
                    .append($('<td></td>').text($postingDate.text()))
                    .append($('<td></td>').text(/*$accountMainID.text() + ":" +*/ $accountMainDescription.text()))
                    .append($('<td></td>').text(/*$accountSubID.text() + ":" +*/ $accountSubDescription.text() + "(" + $accountSubType.text() + ")"))
                    .append($('<td></td>').text(""))
                    .append($('<td></td>').text(""))
            ...
            $tableDetail2 = $('<table class="detail" width="97%" border="1" cellpadding="5"></table>');
            $("#trace")
                .append($('<table width="97%"/>')
                .append($('<tr/>'))
                .append($('<td width="20%" valign="top" style="color:#333; background:#ded;"></td>').text("... Detail " + (line+1)))
                .append($('<td></td>').append($tableDetail2)));
            $tableDetail2.append($("<tr style=\"color:#333; background:#ded;\"/>")
                .append($('<td width="30%"></td>').text("item"))
                .append($('<td></td>').text("value")));
            if ($lineNumber.text())
                $tableDetail2.append($("<tr/>")
